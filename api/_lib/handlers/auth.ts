...
import { checkRateLimit, recordFailedAttempt } from "../middleware/rate-limiter.js";
import { storeSession } from "../services/session-store.js";
...
export default async function handler(req: ApiRequest, res: ApiResponse) {
  ...
  if (action === "me") {
    ...
    try {
      ...
      console.log(
        "👤 DB lookup result:",
        dbUser ? `Found: ${dbUser.email}` : "NOT FOUND",
        "userId type:",
        typeof userId,
        "value:",
