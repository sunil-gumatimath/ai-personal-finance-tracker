...
export function AIAgentChat() {
	...
	// Clear the cooldown flag once it expires so the button re-enables.
	useEffect(() => {
							...
							>
								...
								<div
									className={cn(
										...
										m.role === "user"
											? "bg-primary text-primary-foreground"
											: "bg-muted prose prose-sm dark:prose-invert max-w-none prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-li:my-0.5 prose-strong:font-semibold prose-table:block prose-table:overflow-x-auto prose-table:text-xs prose-th:px-2 prose-th:py-0.5 prose-td:px-2 prose-td:py-0.5 prose-table:border-collapse",
									)}
								>
									{m.role === "assistant" ? (
